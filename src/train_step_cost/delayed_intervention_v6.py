...
def train_step_cost(actor, cost_buffer, error_function, activate_loss=False, expert_policy=None,
    ...
    No preint data
    Does not include preference loss where noisy inbetween data should be less than 1
    """
    ...
    with tf.GradientTape() as tape:
        ...
        preference_loss = preference_loss_1 + preference_loss_3 + preference_loss_2  # + preference_loss_5
